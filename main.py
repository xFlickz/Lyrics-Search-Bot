...
async def start(bot, update):
    ...
    BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton("Channel 🔰", url = "https://telegram.me/xFlickbot" ),InlineKeyboardButton("Support Group ⭕️", url = ""https://telegram.me/SharingUserbot)],[InlineKeyboardButton("Repo 🗂️", url = "https://github.com/XFlickz/Lyrics-Search-Bot"),InlineKeyboardButton("Deploy 🗃️", url = "https://heroku.com/deploy?template=https://github.com/XFlickz/Lyrics-Search-Bot")],[InlineKeyboardButton("Developer 💡", url = "https://github.com/XFlickz/")]])
...
async def help(bot, update):
    ...
    HELP_BUTTON = InlineKeyboardMarkup([[InlineKeyboardButton("🧑‍💻 Channel", url = "https://telegram.me/xFlickbot"),InlineKeyboardButton("🗃️ Source Code", url = "https://github.com/XFlickz/Lyrics-Search-Bot")]])
    await update.reply_text(
...
async def sng(bot, message):
        ...
        try:
                await hy.delete()
                await Ek.send_message(chat_id, text = rpl, reply_to_message_id = message.message_id, reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("Dev 🔗 ", url = f"github.com/XFlickz")], [InlineKeyboardButton("🧑‍💻 Channel", url = "https://telegram.me/xFlickbot"),InlineKeyboardButton("🗃️ Source Code", url = "https://github.com/XFlickz/Lyrics-Search-Bot")]]))
        except Exception as e:
        	await message.reply_text(f"I Can't Find A Song With `{song}`", quote = True, reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("🧑‍💻 Developer", url = f"github.com/XFlickz")], [InlineKeyboardButton("🧑‍💻 Channel", url = "https://telegram.me/xFlickbot"),InlineKeyboardButton("🗃️ Source Code", url = "https://github.com/XFlickz/Lyrics-Search-Bot")]]))
